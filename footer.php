<?php
//Appearance Config
$companyName = get_theme_mod('lpc_company_name');
$email_address = get_theme_mod('lpc_email');
$telephone_no = get_theme_mod('lpc_telephone');
$address = get_theme_mod('lpc_address');
$street = get_theme_mod('lpc_street');
$area = get_theme_mod('lpc_area');
$postCode = get_theme_mod('lpc_postCode');
$facebook = get_theme_mod('lpc_social_facebook');
$twitter = get_theme_mod('lpc_social_twitter');
$instagram = get_theme_mod('lpc_social_instagram');
$linkedIn = get_theme_mod('lpc_social_linkedIn');
?>
...
<footer class="relative bg hidden lg:block">
    <div class="footer-bg relative">
        <img class="footer-main-bg"
            src="<?php echo get_template_directory_uri(  )?>/images/svg/footer-background-updated.png" alt="" />

        <div class="tractor">
            <img src="<?php echo get_template_directory_uri(  )?>/images/footer-tractor.png" alt="" />
        </div>

        <div class="bg-fans overflow-hidden h-full">
            <div class="bg-fan-1 w-full flex flex-row items-end gap-5">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-80 0 150 130"
                    enable-background="new 0 0 250 150" xml:space="preserve">
                    <g id="XMLID_1_">
                        <g id="tower" fill="#000">
                            <polygon id="XMLID_3_" fill="#395442" stroke="#395442" stroke-miterlimit="10"
                                points="44.7,55.6 44.2,150 49.2,150" />
                        </g>
                        <g id="XMLID_2_">
                            <ellipse fill="#395442" id="rotator" cx="44.6" cy="55.6" rx="2.4" ry="2.6" />
                            <g id="blade_1-1">
                                <polyline id="XMLID_90_" fill="#395442" stroke="#395442" stroke-width="3"
                                    stroke-miterlimit="10" points="44.4,54.9 45.3,27.4,54.9" />
                            </g>
                            <g id="blade_1-2">
                                <polyline id="XMLID_9_" fill="#395442" stroke="#395442" stroke-width="3"
                                    stroke-miterlimit="10" points="43.7,56.4 21.3,69 
                          36.9" />
                            </g>
                            <g id="blade_1-3">
                                <polyline id="XMLID_10_" fill="#395442" stroke="#395442" stroke-width="3"
                                    stroke-miterlimit="10" points="45.4,55.6 66.6,70.5 
                          50.4," />
                            </g>
                        </g>
                    </g>
                ...
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 130"
                    enable-background="new 0 0 200 130" xml:space="preserve">
                    <g id="XMLID_1_">
                        <g id="tower" fill="#000">
                            <polygon id="XMLID_3_" fill="#395442" stroke="#395442" stroke-miterlimit="10"
                                points="44.7,55.6 44.2,150 49.2,150" />
        ...
        <div class="birds">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" fill="#395442" viewBox="0 0 54.05 16.35"
                style="enable-background: new 0 0 54.05 16.35" xml:space="preserve">
                ...
                <path
                    d="M29.57,6.77c0,0-0.13-0.02-0.19-0.04c-1.08-0.2-2.23-0.14-3.81-1.58c0,0-0.4,0.16,0.23,1.48c0.63,1.32-0.83,0.85-0.83,0.85
            ...
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" fill="#395442" viewBox="0 0 37.99 34.89"
                style="enable-background: new 0 0 37.99 34.89" xml:space="preserve">
                ...
                <path
                    d="M14.34,29.37c0,0.01,0.07,0.06,0.1,0.09c0.58,0.5,0.9,0.95,2.34,1.13c0,0-0.33,0.66-1.29,0.95
            ...
            <svg version="1.1" id="Layer_1" fill="#395442" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32.22 13.89"
                style="enable-background: new 0 0 32.22 13.89" xml:space="preserve">
    ...
    <div class="inner-container">
        ...
        <div class="footer-content absolute -bottom-20 bg-footerGreen w-full left-0">
            <div class="inner-container footer-contents flex flex-row text-white">
                <div
                    class="footer-grid-1 grid grid-cols-2 lg:grid-cols-3 place-content-between text-white flex-3 overflow-hidden">
                    <div class="footer-logo-container">

                        <a id="logo" href="<?php echo esc_url(home_url('/')); ?>"
                            title="<?php echo get_theme_mod('lpc_company_name'); ?>">
                            <img class="w-60 mx-auto" src="<?php echo get_theme_mod('lpc_footer_logo'); ?>"
                                alt="<?php echo get_theme_mod('lpc_company_name'); ?>_footer_logo" />
                        </a>
                    </div>
                    <div class="footer-links-contianer flex flex-col items-center gap-y-2">
                    ...
                    <div class="social-icons-container list-none flex flex-col items-center gap-y-2">
                        <h2 class="font-primaryBold text-lg lg:text-xl">Oink! Oink!</h2>
                        <div class="footer-social-icons">
                            <div
                                class="social-icons flex flex-row gap-4 items-center pl-2 text-secondary text-2xl relative mt-4">
                ...
                <div class="stamp-container flex flex-col items-center flex-1 overflow-hidden">
                    <img c src="<?php echo get_template_directory_uri(  )?>/images/footer-stamp.png" alt="" />
                </div>
...
<footer class="section-starts relative bg lg:hidden">
    <div class="footer-bg relative">
        <img class="footer-main-bg"
            src="<?php echo get_template_directory_uri(  )?>/images/footer-background-updated.png" alt="" />
        <div class="tractor">
            <img src="<?php echo get_template_directory_uri(  )?>/images/footer-tractor.png" alt="" />
        </div>
    ...
    <div class="inner-container">
        <div class="footer-content absolute -bottom-32 bg-footerGreen w-full left-0 overflow-hidden">
            <div
                ...
                <div class="footer-logo-container w-5/6 mx-auto">
                ...
                <div class="stamp-container w-2/5 mx-auto">
                    <img src="<?php echo get_template_directory_uri(  )?>/images/footer-stamp.png" alt="" />
                </div>
