...
<section class="stockists-container w-full h-full relative z-10">
    <div class="inner-container w-full h-full">
        <div class="main-heading text-center mt-20">
            <h1 class="text-2xl text-slate font-primaryBold md:text-3xl lg:text-4xl">
                <?php echo $headerText ?>
            </h1>
				...
				else 
				{
					echo "<li data-letter=".$posts_array[$i].">";
						...
						// echo "</a>"; ?>
                            ...
                            <div class="flex flex-col items-center bg-gray-100 w-full p-2 lg:w-52 h-52">
                                <img class="flex-1 object-contain w-44" src="<?php echo get_field('stockists_image') ?>"
                                    alt="" />
